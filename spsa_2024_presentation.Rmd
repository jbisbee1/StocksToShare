...
```{r xaringanExtra, echo = FALSE}
  ...
  xaringanExtra::use_banner(
    top_left = "Stocks and Jobs: SPSA 2024",
    top_right = "Bisbee & Clinton",
...
```{r,echo=F,warning=F,message=F,fig.align='center',fig.width=16,fig.height=7,dpi=72}
require(plotly)
p <- toanal %>%
...
- We have 8906 stocks, 1098 municipal securities, 421 corporate bonds, and then a bunch of other things that show up in fewer than 3% of total transactions. 
  ...
  - Stock options are 272 out of 12,104 total transactions in the trial data.
	...
	- We also have information on the financial instrument, although the majority are missing, followed by CLASS A
